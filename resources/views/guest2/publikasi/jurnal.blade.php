                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="single-blog-meta">
                            <div class="img-box">
                                <img src="{{url('publikasi/'.$jurnal->gambar)}}" alt="" style="width:100%; height: 339px; object-fit: cover; object-position: center;">
                                <a href="{{url('publikasi/'.$jurnal->file)}}" class="date">Download</a>
                            </div>
                            <div class="text">
                                {{-- <ul class="jurnal-info clearfix">
                                ...
                                data-deskripsi="{{$jurnal->deskripsi}}"><a href="#">{!!Str::limit($jurnal->judul,150)!!}</a></h6>
                            </div> <!-- /.text -->
